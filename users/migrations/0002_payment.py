    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_type', models.CharField(choices=[('Перевод', 'Перевод'), ('Наличными', 'Наличными')], max_length=150, verbose_name='Тип оплаты')),
                ('paid_courses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.course', verbose_name='Оплаченный курс')),
